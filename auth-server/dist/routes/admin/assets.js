export const adminAssetRoutes = async (fastify, options) => {
    const preHandler = [fastify.authenticate, fastify.requireAdmin];
    fastify.get("/v1/admin/assets", { preHandler }, async (request) => {
    ...
    fastify.delete("/v1/admin/assets/:id", { preHandler }, async (request, reply) => {
